...
var AuthGuard = /** @class */ (function () {
    ...
    AuthGuard = __decorate([
        ...
        __metadata("design:paramtypes", [_angular_router__WEBPACK_IMPORTED_MODULE_1__["Router"], ngx_cookie__WEBPACK_IMPORTED_MODULE_2__["CookieService"]])
    ], AuthGuard);
    return AuthGuard;
}());
...
/* harmony import */ var _passwordValidation__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./passwordValidation */ "./src/app/_helpers/passwordValidation.ts");
...
/***/ "./src/app/_helpers/passwordValidation.ts":
/*!************************************************!*\
  !*** ./src/app/_helpers/passwordValidation.ts ***!
  \************************************************/
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = (function (otherControlName) {
    var thisControl;
    var otherControl;
...
var AuthenticationService = /** @class */ (function () {
    ...
    AuthenticationService.prototype.login = function (emailOrUsername, password) {
        return this.http
    ...
    AuthenticationService.prototype.getUserData = function () {
        var decodedUser = jwt_decode__WEBPACK_IMPORTED_MODULE_4__(this.cookieService.get('accessToken'));
        return decodedUser;
    };
...
var BASE_URL = _environments_environment__WEBPACK_IMPORTED_MODULE_4__["environment"].apiUrl;
var ChatService = /** @class */ (function () {
    function ChatService(http) {
        this.http = http;
        this.chatUrl = _environments_environment__WEBPACK_IMPORTED_MODULE_4__["environment"].apiUrl;
        this.apiUrl = BASE_URL + "/messages";
        this.usersUrl = BASE_URL + "/users/all";
    }
    ChatService.prototype.connect = function (username, callback) {
        var _this = this;
        if (callback === void 0) { callback = function () { }; }
        // initialize the connection
        this.socket = socket_io_client__WEBPACK_IMPORTED_MODULE_3__(this.chatUrl, { path: '/chat' });
    ...
    ChatService.prototype.getConversation = function (chatWith) {
        var url = this.apiUrl;
...
/*!************************************!*\
  !*** ./src/app/_services/index.ts ***!
  \************************************/
/*! exports provided: AlertService, AuthenticationService, UserService, ChatService */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var _chat_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./chat.service */ "./src/app/_services/chat.service.ts");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "ChatService", function() { return _chat_service__WEBPACK_IMPORTED_MODULE_3__["ChatService"]; });
...
var UserService = /** @class */ (function () {
    ...
    UserService.prototype.getAll = function () {
        return this.http.get(_environments_environment__WEBPACK_IMPORTED_MODULE_2__["environment"].apiUrl + "/users/all");
    };
    UserService.prototype.getProfile = function () {
        return this.http.get(_environments_environment__WEBPACK_IMPORTED_MODULE_2__["environment"].apiUrl + "/users/current");
    };
    UserService.prototype.register = function (user) {
        return this.http.post(_environments_environment__WEBPACK_IMPORTED_MODULE_2__["environment"].apiUrl + "/auth/register", user);
    };
    UserService.prototype.updateProfile = function (user) {
        return this.http.patch(_environments_environment__WEBPACK_IMPORTED_MODULE_2__["environment"].apiUrl + "/users/current", user);
    };
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _active_list_component__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./active-list.component */ "./src/app/active-list/active-list.component.ts");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "ActiveListComponent", function() { return _active_list_component__WEBPACK_IMPORTED_MODULE_0__["ActiveListComponent"]; });
...
/* harmony import */ var _navbar__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ./navbar */ "./src/app/navbar/index.ts");
/* harmony import */ var _profile__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! ./profile */ "./src/app/profile/index.ts");
/* harmony import */ var _refresh_refresh_component__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! ./refresh/refresh.component */ "./src/app/refresh/refresh.component.ts");
/* harmony import */ var _chat_room__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(/*! ./chat-room */ "./src/app/chat-room/index.ts");
/* harmony import */ var _active_list__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(/*! ./active-list */ "./src/app/active-list/index.ts");
/* harmony import */ var _message__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(/*! ./message */ "./src/app/message/index.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
    ...
    AppModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["NgModule"])({
            ...
            declarations: [
                ...
                _navbar__WEBPACK_IMPORTED_MODULE_15__["NavbarComponent"],
                _profile__WEBPACK_IMPORTED_MODULE_16__["ProfileComponent"],
                _refresh_refresh_component__WEBPACK_IMPORTED_MODULE_17__["RefreshComponent"],
                _chat_room__WEBPACK_IMPORTED_MODULE_18__["ChatRoomComponent"],
                _active_list__WEBPACK_IMPORTED_MODULE_19__["ActiveListComponent"],
                _message__WEBPACK_IMPORTED_MODULE_20__["MessageComponent"]
            ],
            providers: [
                ...
                _services__WEBPACK_IMPORTED_MODULE_10__["ChatService"]
            ],
...
/* harmony import */ var _refresh__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./refresh */ "./src/app/refresh/index.ts");
/* harmony import */ var _chat_room__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./chat-room */ "./src/app/chat-room/index.ts");
...
var appRoutes = [
    ...
    { path: 'profile', component: _profile__WEBPACK_IMPORTED_MODULE_5__["ProfileComponent"], canActivate: [_guards__WEBPACK_IMPORTED_MODULE_1__["AuthGuard"]] },
    {
        path: 'chat',
        canActivate: [_guards__WEBPACK_IMPORTED_MODULE_1__["AuthGuard"]],
        children: [
            { path: ':chatWith', component: _chat_room__WEBPACK_IMPORTED_MODULE_7__["ChatRoomComponent"] },
            { path: '**', redirectTo: '/chat/chat-room', pathMatch: 'full' }
        ]
    },
    // Just for refresh purpose
    { path: 'refresh', component: _refresh__WEBPACK_IMPORTED_MODULE_6__["RefreshComponent"] },
...
/* harmony import */ var _services_chat_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../_services/chat.service */ "./src/app/_services/chat.service.ts");
...
var ChatRoomComponent = /** @class */ (function () {
    function ChatRoomComponent(route, router, formBuilder, el, authenticationService, chatService) {
        this.route = route;
        this.router = router;
    ...
    ChatRoomComponent.prototype.getMessages = function (chatWith) {
        var _this = this;
        this.chatService.getConversation(chatWith).subscribe(function (data) {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _chat_room_component__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./chat-room.component */ "./src/app/chat-room/chat-room.component.ts");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "ChatRoomComponent", function() { return _chat_room_component__WEBPACK_IMPORTED_MODULE_0__["ChatRoomComponent"]; });
...
module.exports = "<div class=\"container\">\n    <div class=\"jumbotron text-center\">\n        <h1>Chat together</h1>\n        <p class=\"lead\">به چت روم \"با هم چت کنیم\" خوش آمدید</p>\n        <div *ngIf=\"!this.authenticationService.loggedIn()\">\n            <a class=\"btn btn-primary\" [routerLink]=\"['/register']\">ثبت نام</a>\n            <span style=\"margin-left:4px; margin-right:4px;\">یا</span>\n            <a class=\"btn btn-info\" [routerLink]=\"['/login']\">ورود</a>\n        </div>\n\n        <div *ngIf=\"this.authenticationService.loggedIn()\">\n            <a class=\"btn btn-primary\" [routerLink]=\"['/chat']\">ورود به چت روم</a>\n        </div>\n    </div>\n\n    <div class=\"row\">\n        <div class=\"col-md-4 text-center\">\n            <h3>NodeJS Backend</h3>\n            <p>برای توسعه سرور از فریمورک ند استفاده شده است</p>\n            <p>\n                <a href=\"https://nodejs.org/\" target=\"_blank\">node</a> |\n                <a href=\"https://expressjs.com/\" target=\"_blank\">express</a> |\n                <a href=\"https://www.mongodb.com/\" target=\"_blank\">mongo</a>\n            </p>\n        </div>\n        <div class=\"col-md-4 text-center\">\n            <h3>Socket.io</h3>\n            <p>برای پیاده سازی قسمت چت روم از کتاب خانه سوکت استفاده شده است</p>\n            <p>\n                <a href=\"https://socket.io/\" target=\"_blank\">socket.io</a>\n            </p>\n        </div>\n        <div class=\"col-md-4 text-center\">\n            <h3>Angular</h3>\n            <p>برای توسعه رابط کاربری از فریمورک انگیولار استفاده شده است</p>\n            <p>\n                <a href=\"https://angular.io/\" target=\"_blank\">angular</a>\n            </p>\n        </div>\n    </div>\n</div>"
...
var LoginComponent = /** @class */ (function () {
    ...
    LoginComponent.prototype.ngOnInit = function () {
        this.loginForm = this.formBuilder.group({
            emailOrUsername: ['', _angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].required],
...
/* harmony import */ var _models_message__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../_models/message */ "./src/app/_models/message.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var MessageComponent = /** @class */ (function () {
    function MessageComponent(authenticationService) {
        this.authenticationService = authenticationService;
    }
    ...
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Input"])(),
        __metadata("design:type", _models_message__WEBPACK_IMPORTED_MODULE_3__["Message"])
...
module.exports = "<nav class=\"navbar navbar-default navbar-fixed-top\">\n    <div class=\"container-fluid\">\n        <div class=\"navbar-header\">\n            <button type=\"button\" class=\"navbar-toggle collapsed\" data-toggle=\"collapse\" data-target=\"#bs-example-navbar-collapse-1\"\n                aria-expanded=\"false\">\n                <span class=\"sr-only\">Toggle navigation</span>\n                <span class=\"icon-bar\"></span>\n                <span class=\"icon-bar\"></span>\n                <span class=\"icon-bar\"></span>\n            </button>\n\n            <a routerLink=\"/\" class=\"navbar-brand\">\n                <span><img alt=\"Brand\" src=\"assets/images/brand.ico\" width=\"34px\" height=\"34px\"></span>\n                ChaTogether\n            </a>\n        </div>\n\n        <div class=\"collapse navbar-collapse\" id=\"bs-example-navbar-collapse-1\">\n            <ul class=\"nav navbar-nav navbar-left\">\n                <li routerLinkActive=\"active\" [routerLinkActiveOptions]=\"{exact:true}\"><a routerLink=\"/\">خانه</a></li>\n                <li *ngIf=\"authenticationService.loggedIn()\" routerLinkActive=\"active\"><a routerLink=\"/chat\">چت</a></li>\n            </ul>\n\n            <ul class=\"nav navbar-nav navbar-right\">\n                <li *ngIf=\"!authenticationService.loggedIn()\" routerLinkActive=\"active\"><a routerLink=\"/login\">ورود</a></li>\n                <li *ngIf=\"!authenticationService.loggedIn()\" routerLinkActive=\"active\"><a routerLink=\"/register\">ثبت نام</a></li>\n                <li *ngIf=\"authenticationService.loggedIn()\" routerLinkActive=\"active\"><a routerLink=\"/profile\">پروفایل</a></li>\n                <li *ngIf=\"authenticationService.loggedIn()\"><a href=\"#\" (click)=\"onLogoutClick()\">خروج</a></li>\n            </ul>\n        </div>\n    </div>\n</nav>"
...
var NavbarComponent = /** @class */ (function () {
    function NavbarComponent(authenticationService, chatService, router) {
        this.authenticationService = authenticationService;
        this.chatService = chatService;
        this.router = router;
    }
...
/* harmony import */ var _helpers_passwordValidation__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../_helpers/passwordValidation */ "./src/app/_helpers/passwordValidation.ts");
...
var ProfileComponent = /** @class */ (function () {
    function ProfileComponent(formBuilder, router, userService, alertService, cookieService) {
        this.formBuilder = formBuilder;
        this.router = router;
        ...
        this.uploader = new ng2_file_upload__WEBPACK_IMPORTED_MODULE_4__["FileUploader"]({
            url: _environments_environment__WEBPACK_IMPORTED_MODULE_8__["environment"].apiUrl + "/users/uploadpic",
            itemAlias: 'photo',
    ...
    ProfileComponent.prototype.ngOnInit = function () {
        ...
        this.userService.getProfile().subscribe(function (user) {
            ...
            _this.profileForm = _this.formBuilder.group({
                ...
                instagram: [_this.user.social.instagram],
                linkedin: [_this.user.social.linkedin],
                telegram: [_this.user.social.telegram],
                github: [_this.user.social.github],
                currentPassword: [''],
                newPassword: ['', _angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].minLength(6)],
                newConfirmPassword: ['', Object(_helpers_passwordValidation__WEBPACK_IMPORTED_MODULE_6__["default"])('newPassword')]
            });
        }, function (err) {
            return false;
        });
        this.uploader.onCompleteItem = function (item, response, status, headers) {
            ...
            if (!response.success) {
                window.scrollTo(0, 0);
                _this.alertService.error('Profile picture must be a PNG or JPEG less than 1 MB');
                _this.loading = false;
                return;
            }
            _this.router
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _refresh_component__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./refresh.component */ "./src/app/refresh/refresh.component.ts");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "RefreshComponent", function() { return _refresh_component__WEBPACK_IMPORTED_MODULE_0__["RefreshComponent"]; });
...
var RefreshComponent = /** @class */ (function () {
    ...
    RefreshComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({ template: __webpack_require__(/*! ./refresh.component.html */ "./src/app/refresh/refresh.component.html") })
    ], RefreshComponent);
...
module.exports = "<div class=\"limiter\">\n    <div class=\"container-login100\">\n        <div class=\"wrap-login100 p-l-55 p-r-55 p-b-54\">\n            <form class=\"login100-form validate-form\" [formGroup]=\"registerForm\" (ngSubmit)=\"onSubmit()\">\n                <span class=\"login100-form-title p-b-49\">\n                    ثبت نام\n                </span>\n\n                <div class=\"wrap-input100 validate-input m-b-23 form-group\" data-validate=\"First name is required\" dir=\"rtl\" >\n                    <span class=\"label-input100\">نام</span>\n                    <input class=\"input100 form-control\" type=\"text\" formControlName=\"firstName\" [ngClass]=\"{ 'is-invalid': submitted && f.firstName.errors }\"\n                        placeholder=\"نام\">\n                    <span class=\"focus-input100\" data-symbol=\"&#xf206;\"></span>\n                    <div *ngIf=\"submitted && f.firstName.errors\" class=\"invalid-feedback\">\n                        <div *ngIf=\"f.firstName.errors.required\">First name is required</div>\n                    </div>\n                </div>\n\n                <div class=\"wrap-input100 validate-input m-b-23 form-group\" data-validate=\"Last name is required\" dir=\"rtl\" >\n                    <span class=\"label-input100\">نام خانوادگی</span>\n                    <input class=\"input100 form-control\" type=\"text\" formControlName=\"lastName\" [ngClass]=\"{ 'is-invalid': submitted && f.lastName.errors }\"\n                        placeholder=\"نام خانوادگی\">\n                    <span class=\"focus-input100\" data-symbol=\"&#xf206;\"></span>\n                    <div *ngIf=\"submitted && f.lastName.errors\" class=\"invalid-feedback\">\n                        <div *ngIf=\"f.lastName.errors.required\">Last name is required</div>\n                    </div>\n                </div>\n\n                <div class=\"wrap-input100 validate-input m-b-23 form-group\" data-validate=\"Username is reauired\" dir=\"rtl\" >\n                    <span class=\"label-input100\">نام کاربری</span>\n                    <input class=\"input100 form-control\" type=\"text\" formControlName=\"username\" [ngClass]=\"{ 'is-invalid': submitted && f.username.errors }\"\n                        placeholder=\"نام کاربری\">\n                    <span class=\"focus-input100\" data-symbol=\"&#xf206;\"></span>\n                    <div *ngIf=\"submitted && f.username.errors\" class=\"invalid-feedback\">\n                        <div *ngIf=\"f.username.errors.required\">Username is required</div>\n                        <div *ngIf=\"f.username.errors.minlength\">Username must be at least 3 characters</div>\n                    </div>\n                </div>\n\n                <div class=\"wrap-input100 validate-input m-b-23 form-group\" data-validate=\"Email is reauired\" dir=\"rtl\" >\n                    <span class=\"label-input100\">ایمیل</span>\n                    <input class=\"input100 form-control\" type=\"text\" formControlName=\"email\" [ngClass]=\"{ 'is-invalid': submitted && f.email.errors }\"\n                        placeholder=\"ایمیل\">\n                    <span class=\"focus-input100\" data-symbol=\"&#9993;\"></span>\n                    <div *ngIf=\"submitted && f.email.errors\" class=\"invalid-feedback\">\n                        <div *ngIf=\"f.email.errors.required\">Email is required</div>\n                        <div *ngIf=\"f.email.errors.email\">Invalid email</div>\n                    </div>\n                </div>\n\n                <div class=\"wrap-input100 validate-input form-group\" data-validate=\"Password is required\" dir=\"rtl\" >\n                    <span class=\"label-input100\">پسورد</span>\n                    <input class=\"input100 form-control\" type=\"password\" formControlName=\"password\" [ngClass]=\"{ 'is-invalid': submitted && f.password.errors }\"\n                        placeholder=\"پسورد\">\n                    <span class=\"focus-input100\" data-symbol=\"&#xf190;\"></span>\n                    <div *ngIf=\"submitted && f.password.errors\" class=\"invalid-feedback\">\n                        <div *ngIf=\"f.password.errors.required\">Password is required</div>\n                        <div *ngIf=\"f.password.errors.minlength\">Password must be at least 6 characters</div>\n                    </div>\n                </div>\n\n                <div class=\"wrap-input100 validate-input form-group\" data-validate=\"Confirm password is required\" dir=\"rtl\" >\n                    <span class=\"label-input100\">تایید پسورد</span>\n                    <input class=\"input100 form-control\" type=\"password\" formControlName=\"confirmPassword\" [ngClass]=\"{ 'is-invalid': submitted && f.confirmPassword.errors }\"\n                        placeholder=\"تایید پسورد\">\n                    <span class=\"focus-input100\" data-symbol=\"&#xf190;\"></span>\n                    <div *ngIf=\"submitted && f.confirmPassword.errors\" class=\"invalid-feedback\">\n                        <div *ngIf=\"f.confirmPassword.errors?.Match\">Password not match</div>\n                    </div>\n                </div>\n\n                <div class=\"container-login100-form-btn\">\n                    <div class=\"wrap-login100-form-btn form-group\">\n                        <div class=\"login100-form-bgbtn\"></div>\n                        <button [hidden]=\"loading\" class=\"login100-form-btn\">\n                            ثبت نام\n                        </button>\n                    </div>\n                    <img *ngIf=\"loading\" align=\"center\" src=\"assets/images/loading.gif\" />\n                </div>\n\n                <div class=\"txt1 text-center p-t-54 p-b-20\">\n                    <span>\n                        ثبت نام با شبکه های اجتماعی\n                    </span>\n                </div>\n\n                <div class=\"flex-c-m\">\n                    <a href=\"auth/github\" class=\"login100-social-item bg1\">\n                        <i class=\"fa fa-github\"></i>\n                    </a>\n\n                    <a href=\"auth/linkedin\" class=\"login100-social-item bg2\">\n                        <i class=\"fa fa-linkedin\"></i>\n                    </a>\n\n                    <a href=\"auth/google\" class=\"login100-social-item bg3\">\n                        <i class=\"fa fa-google\"></i>\n                    </a>\n                </div>\n\n                <div class=\"flex-col-c\">\n                    <hr>\n                    <span class=\"txt1 p-b-17\">\n                        قبلا ثبت نام کرده اید؟\n                    </span>\n\n                    <a [routerLink]=\"['/login']\" class=\"txt2\">\n                        ورود\n                    </a>\n                </div>\n            </form>\n        </div>\n    </div>\n</div>"
...
/* harmony import */ var _angular_forms__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/forms */ "./node_modules/@angular/forms/fesm5/forms.js");
/* harmony import */ var rxjs_operators__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! rxjs/operators */ "./node_modules/rxjs/_esm5/operators/index.js");
/* harmony import */ var _helpers_passwordValidation__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../_helpers/passwordValidation */ "./src/app/_helpers/passwordValidation.ts");
...
var RegisterComponent = /** @class */ (function () {
    ...
    RegisterComponent.prototype.ngOnInit = function () {
        this.registerForm = this.formBuilder.group({
            ...
            confirmPassword: [
                '',
                [_angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].required, Object(_helpers_passwordValidation__WEBPACK_IMPORTED_MODULE_4__["default"])('password')]
            ]
        });
    };
...
module.exports = __webpack_require__(/*! /home/miladdarren/CodeStuff/project/client/src/main.ts */"./src/main.ts");
